...
class CommonModel(db.Model):
    ...
    deleted_at = db.Column(BigInteger(), index=True)
...
def simple_model_onupdate_listener(mapper, connection, instance):
    instance.created_at = instance.created_at
    instance.updated_at = floor(time.time())
...
# event.listen(SimpleModel, 'before_insert',
#              model_oncreate_listener, propagate=True)
# event.listen(SimpleModel, 'before_update',
#              simple_model_onupdate_listener, propagate=True)
